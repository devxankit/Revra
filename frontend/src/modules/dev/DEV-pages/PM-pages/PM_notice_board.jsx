...
import { pmNoticeService } from '../../DEV-services'
import { useToast } from '../../../../contexts/ToastContext'
import Loading from '../../../../components/ui/loading'

const PM_notice_board = () => {
  ...
  const fetchNotices = useCallback(async (showLoading = true, customFilter = null, customSearch = null) => {
    try {
      ...
      const response = await pmNoticeService.getNotices(params)
  ...
  const handleNoticeView = async (noticeId) => {
    try {
      await pmNoticeService.incrementNoticeViews(noticeId)
...
export default PM_notice_board
