    ...
    const load = async () => {
      ...
      if (storedPMData) {
        setProfileData({
          ...
          role: storedPMData.role || 'pm',
          department: storedPMData.department || 'Product',
          jobTitle: storedPMData.position || 'Project Manager',
          workTitle: storedPMData.position || 'Project Manager',
          joinDate: storedPMData.joiningDate || new Date(Date.now()-200*24*60*60*1000).toISOString(),
          avatar: 'PM',
          phone: storedPMData.phone || '+91 90000 00000',
          location: 'Indore, IN',
          skills: storedPMData.skills || ['Leadership', 'Scrum']
        })
      } else {
            ...
            <div className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between py-2 border-b border-gray-100">
                  ...
                  <span className="text-xs font-semibold text-gray-900">PM</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-gray-100">
