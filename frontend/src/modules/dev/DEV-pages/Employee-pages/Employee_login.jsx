...
import { loginEmployee, isEmployeeAuthenticated, forgotPasswordEmployee } from '../../DEV-services/employeeAuthService'
          ...
          >
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  const response = await forgotPasswordEmployee(forgotPasswordEmail)
                  if (response.success) {
