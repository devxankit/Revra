...
import { loginSales, isSalesAuthenticated, forgotPasswordSales } from '../SL-services/salesAuthService'
          ...
          >
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  const response = await forgotPasswordSales(forgotPasswordEmail)
                  if (response.success) {
